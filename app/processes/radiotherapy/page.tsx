    ...
    return (
        <main className="flex min-h-screen flex-col px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-x-6">
                <ScarCard title="High Indel Burden" measurement="INDEL / SBS ratio" description="Higher number of INDELS. Driven by a an increased burden of deletions, not insertions." experiment="Analysis of 12 radiation-associated tumours from 3 cancer types compared to radiation-naive tumours" href="https://www.nature.com/articles/ncomms12605"></ScarCard>

                <ScarCard title="High Deletion Burden" measurement="Deletion / Insertion ratio" description="Higher number of small deletions (1-100bp) particularly in reagions of microhomology" experiment="Analysis of 12 radiation-associated tumours from 3 cancer types compared to radiation-naive tumours" href="https://www.nature.com/articles/ncomms12605"></ScarCard>

                <ScarCard title="Topography Agnostic Deletions" measurement="Genome-wide deletion distribution and topographical features" description="Radiation induced deletions appear uniformally across the genome irregardless of replication timing and chromotin structure (unlike most other exogenous mutagens)." experiment="Analysis of 12 radiation-associated tumours from 3 cancer types compared to radiation-naive tumours" href="https://www.nature.com/articles/ncomms12605"></ScarCard>
                <ScarCard title="Increased balanced inversions" measurement="Any balanced inversions present" description="Balanced inversions, a rare type of rearrangement, were present in 92% (11/12) radiation-associated tumours but only 15% of radiation naïve tumours." experiment="Analysis of 12 radiation-associated tumours from 3 cancer types compared to radiation-naive tumours" href="https://www.nature.com/articles/ncomms12605"></ScarCard>
            </div>
